...
# `dbml_sharepoint.typemap`

*Analysis — DBML types to SharePoint field descriptors*
...
```python
def map_column(col: dbml_sharepoint.parser.Column, enum_names: set[str]) -> dbml_sharepoint.typemap.SPField
```

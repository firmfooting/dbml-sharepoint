...
# `dbml_sharepoint.styles`

*Analysis — the fleet style standard*
...
```python
def expand_style(spec: dict[str, typing.Any], context: str, theme: dict[str, dbml_sharepoint.styles.StyleToken] | None = None) -> dict[str, typing.Any]
```
...
```python
def parse_theme(raw: object, context: str) -> dict[str, dbml_sharepoint.styles.StyleToken]
```

...
# `dbml_sharepoint.assessgen`

*Generator — assess.js and assess-manifest.md*
...
```python
def assess_targets(schema: dbml_sharepoint.parser.Schema, bundle: dbml_sharepoint.mapping_loader.MappingBundle, site_role: str) -> dict[str, typing.Any]
```
...
```python
def derive_requirements(schema: dbml_sharepoint.parser.Schema, bundle: dbml_sharepoint.mapping_loader.MappingBundle, site_role: str) -> list[dbml_sharepoint.assessgen.Requirement]
```
...
```python
def generate_assess_js(*, schema: dbml_sharepoint.parser.Schema, bundle: dbml_sharepoint.mapping_loader.MappingBundle, release: dbml_sharepoint.release.Release, site_url: str, site_role: str, source_dbml: str, generated_at: str) -> str
```

### `generate_assess_manifest`

```python
def generate_assess_manifest(*, schema: dbml_sharepoint.parser.Schema, bundle: dbml_sharepoint.mapping_loader.MappingBundle, site_url: str, site_role: str) -> str
```

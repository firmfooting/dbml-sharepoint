...
# `dbml_sharepoint.validator`

*Analysis — fail-closed build-time rules*
...
```python
def validate(schema: dbml_sharepoint.parser.Schema) -> list[dbml_sharepoint.validator.Finding]
```

### `validate_against_mapping`

```python
def validate_against_mapping(schema: dbml_sharepoint.parser.Schema, bundle: dbml_sharepoint.mapping_loader.MappingBundle) -> list[dbml_sharepoint.validator.Finding]
```

### `validate_all`

```python
def validate_all(schema: dbml_sharepoint.parser.Schema, bundle: dbml_sharepoint.mapping_loader.MappingBundle, extension: dbml_sharepoint.extension.DeploymentExtension) -> list[dbml_sharepoint.validator.Finding]
```

...
# `dbml_sharepoint.permissions`

*Analysis — SP base-permission bitmask helpers*
...
```python
def base_permissions_to_high_low(perm_names: list[str]) -> dbml_sharepoint.permissions.HighLow
```

...
# `dbml_sharepoint.reportgen`

*Generator — Power Query / SQL reporting pack*
...
```python
def generate_powerquery(schema: dbml_sharepoint.parser.Schema, bundle: dbml_sharepoint.mapping_loader.MappingBundle, site_role: str) -> dict[str, str]
```
...
```python
def generate_sql_views(schema: dbml_sharepoint.parser.Schema, bundle: dbml_sharepoint.mapping_loader.MappingBundle, site_role: str) -> str
```
...
```python
def generate_reporting_md(schema: dbml_sharepoint.parser.Schema, bundle: dbml_sharepoint.mapping_loader.MappingBundle, site_role: str) -> str
```
...
```python
def generate_data_dictionary(schema: dbml_sharepoint.parser.Schema, bundle: dbml_sharepoint.mapping_loader.MappingBundle, site_role: str, *, release: dbml_sharepoint.release.Release | None = None, generated_at: str = '', source_schema: str = '', source_mapping: str = '') -> str
```
...
```python
def generate_dictionary_powerquery(schema: dbml_sharepoint.parser.Schema, bundle: dbml_sharepoint.mapping_loader.MappingBundle, site_role: str, *, release: dbml_sharepoint.release.Release | None = None, generated_at: str = '', source_schema: str = '', source_mapping: str = '') -> dict[str, str]
```
...
```python
def generate_dictionary_sql(schema: dbml_sharepoint.parser.Schema, bundle: dbml_sharepoint.mapping_loader.MappingBundle, site_role: str, *, release: dbml_sharepoint.release.Release | None = None, generated_at: str = '', source_schema: str = '', source_mapping: str = '') -> str
```
...
```python
def emit_reporting(out: pathlib.Path, schema: dbml_sharepoint.parser.Schema, bundle: dbml_sharepoint.mapping_loader.MappingBundle, site_role: str, *, release: dbml_sharepoint.release.Release | None, generated_at: str, source_schema: str, source_mapping: str) -> list[str]
```

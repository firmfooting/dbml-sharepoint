...
def test_env_settings_has_exactly_the_registered_fields() -> None:
    ...
    assert ENV_SETTINGS[2].key == "DBMLSP_DEPLOY_CHANGES"
    assert ENV_SETTINGS[2].parameter == "deployment_log_change_list"
    assert ENV_SETTINGS[3].key == "DBMLSP_DEPLOY_LOG_SITE"

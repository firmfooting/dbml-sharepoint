...
def test_group_description_ceiling_is_not_redeclared_in_permissions() -> None:
    """The ceiling has one owner, per #167; its value is pinned behaviourally."""
    from dbml_sharepoint.analysis import permissions

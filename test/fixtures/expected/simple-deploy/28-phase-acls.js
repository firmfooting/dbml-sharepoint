      ...
      try {
        ...
        let existingAssignments = null;
        {
          ...
          while (pageUrl && ok) {
            ...
            const next = validatedNextPage(pageJson.d, `Role assignment enumeration for '${la.list}'`);
        ...
        if (la.reconcile_mode === 'exact') {
          ...
          if (allAssignments === null) {
            ...
            while (assignmentsUrl) {
              ...
              const next = validatedNextPage(allJson.d, `Role assignment enumeration for '${la.list}'`);

...
(async () => {
  ...
  // Round one (revision 208a2bce) answered the four on the first line: only
  // ID and Modified resolved, and Title resolved once it was given a value.
  // The rest are every other spelling of a file's identity SharePoint
  // carries, asked together because one look answers all of them.
  const TOKENS = [
    'FileLeafRef', 'Title', 'FileRef', 'Name', 'ID', 'Modified',
    'LinkFilename', 'LinkFilenameNoMenu', 'FileDirRef', 'File_x0020_Name',
    'DocIcon', 'EncodedAbsUrl', 'ServerUrl', 'File_x0020_Type',
  ];

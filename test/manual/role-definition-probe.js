 ...
 *
 * NOT YET RUN. When it has been, record the outcome here in the form the
 * other probes in this directory use: the date, the revision, what was
 * answered, and what each control did.
 */
(async () => {
  // ---- Operator gate -------------------------------------------------
  ...
  log('INFO', 'probe revision 709c2549. Quote this when reporting results.');

 ...
 * to report.
 *
 * R3 AND R9 BOTH NEED A RE-RUN before anything is built on them. Nothing
 * else in run 1 is affected: R1, R2, R5 and R6 each compare a value they
 * themselves sent, R7 compares the bitmap it sent, R4 reports a length, and
 * R8 reports a status code. None of them depend on R3 or R9.
 */
(async () => {
  // ---- Operator gate -------------------------------------------------
  ...
  log('INFO', 'probe revision 4dd7de1c. Quote this when reporting results.');

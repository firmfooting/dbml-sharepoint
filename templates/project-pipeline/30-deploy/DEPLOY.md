...
dbml-sharepoint build \
  --schema templates/project-pipeline/10-design/schema.dbml \
  --mapping templates/project-pipeline/20-configure/mapping.yaml \
  --release templates/project-pipeline/20-configure/release.yaml \

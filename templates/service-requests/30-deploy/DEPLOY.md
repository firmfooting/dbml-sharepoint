...
dbml-sharepoint build \
  --schema templates/service-requests/10-design/schema.dbml \
  --mapping templates/service-requests/20-configure/mapping.yaml \
  --release templates/service-requests/20-configure/release.yaml \
...
first, then `demo-data.js`, from the same bundle. It creates six requests —

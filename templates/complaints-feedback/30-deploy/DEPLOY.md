...
dbml-sharepoint build \
  --schema templates/complaints-feedback/10-design/schema.dbml \
  --mapping templates/complaints-feedback/20-configure/mapping.yaml \
  --release templates/complaints-feedback/20-configure/release.yaml \
...
first, then `demo-data.js`, from the same bundle. It creates six items —

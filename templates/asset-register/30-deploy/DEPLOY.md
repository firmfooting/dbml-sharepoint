...
dbml-sharepoint build \
  --schema templates/asset-register/10-design/schema.dbml \
  --mapping templates/asset-register/20-configure/mapping.yaml \
  --release templates/asset-register/20-configure/release.yaml \

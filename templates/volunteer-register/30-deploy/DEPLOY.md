...
dbml-sharepoint build \
  --schema templates/volunteer-register/10-design/schema.dbml \
  --mapping templates/volunteer-register/20-configure/mapping.yaml \
  --release templates/volunteer-register/20-configure/release.yaml \

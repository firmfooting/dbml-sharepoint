...
dbml-sharepoint build \
  --schema templates/vehicle-log/10-design/schema.dbml \
  --mapping templates/vehicle-log/20-configure/mapping.yaml \
  --release templates/vehicle-log/20-configure/release.yaml \

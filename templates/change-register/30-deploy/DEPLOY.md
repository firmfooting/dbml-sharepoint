...
dbml-sharepoint build \
  --schema templates/change-register/10-design/schema.dbml \
  --mapping templates/change-register/20-configure/mapping.yaml \
  --release templates/change-register/20-configure/release.yaml \
...
then `demo-data.js`, from the same bundle. It creates six rows — two waiting

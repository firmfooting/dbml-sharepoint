...
dbml-sharepoint build \
  --schema templates/measures-register/10-design/schema.dbml \
  --mapping templates/measures-register/20-configure/mapping.yaml \
  --release templates/measures-register/20-configure/release.yaml \

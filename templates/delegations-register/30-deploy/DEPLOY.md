...
dbml-sharepoint build \
  --schema templates/delegations-register/10-design/schema.dbml \
  --mapping templates/delegations-register/20-configure/mapping.yaml \
  --release templates/delegations-register/20-configure/release.yaml \

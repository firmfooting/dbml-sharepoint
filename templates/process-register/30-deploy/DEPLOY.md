...
dbml-sharepoint build \
  --schema templates/process-register/10-design/schema.dbml \
  --mapping templates/process-register/20-configure/mapping.yaml \
  --release templates/process-register/20-configure/release.yaml \
...
then `demo-data.js`, from the same bundle. It creates six rows across four

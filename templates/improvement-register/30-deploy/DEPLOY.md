...
validation errors) → **paste** `build/deploy.js` from a Site Owner's console
...
dbml-sharepoint build \
  --schema templates/improvement-register/10-design/schema.dbml \
  --mapping templates/improvement-register/20-configure/mapping.yaml \
  --release templates/improvement-register/20-configure/release.yaml \

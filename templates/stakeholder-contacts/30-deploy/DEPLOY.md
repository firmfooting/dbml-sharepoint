...
dbml-sharepoint build \
  --schema templates/stakeholder-contacts/10-design/schema.dbml \
  --mapping templates/stakeholder-contacts/20-configure/mapping.yaml \
  --release templates/stakeholder-contacts/20-configure/release.yaml \

...
dbml-sharepoint build \
  --schema templates/training-register/10-design/schema.dbml \
  --mapping templates/training-register/20-configure/mapping.yaml \
  --release templates/training-register/20-configure/release.yaml \

...
dbml-sharepoint build \
  --schema templates/equipment-maintenance/10-design/schema.dbml \
  --mapping templates/equipment-maintenance/20-configure/mapping.yaml \
  --release templates/equipment-maintenance/20-configure/release.yaml \

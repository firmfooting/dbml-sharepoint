...
dbml-sharepoint build \
  --schema templates/contract-register/10-design/schema.dbml \
  --mapping templates/contract-register/20-configure/mapping.yaml \
  --release templates/contract-register/20-configure/release.yaml \
...
then `demo-data.js`, from the same bundle. It creates five rows — one per

...
dbml-sharepoint build \
  --schema templates/routine-checks/10-design/schema.dbml \
  --mapping templates/routine-checks/20-configure/mapping.yaml \
  --release templates/routine-checks/20-configure/release.yaml \

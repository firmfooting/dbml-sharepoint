...
Rule 2's first half is now fully enforced. Its second half cannot be, and
rules 1 and 3 cannot be either.

**Enforced at save — SharePoint rejects the row:**

| Rule | List | Where it lives |
|---|---|---|
| Rule 2: a *Closed* recommendation needs an `EvidenceUrl` | Recommendation | list validation |

...
dbml-sharepoint build \
  --schema templates/grants-register/10-design/schema.dbml \
  --mapping templates/grants-register/20-configure/mapping.yaml \
  --release templates/grants-register/20-configure/release.yaml \

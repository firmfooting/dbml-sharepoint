...
#: forty-condition filter to ten, and `view.filter-editor.condition-slot-count`
#: (C4 in those runs, on `view-edit-page-probe.js`) read ten `FieldPicker` and
#: ten `OperatorPicker` controls out of the page markup.

# src/dbml_sharepoint/model/errors.py
...
class MappingShapeError(MappingError):
...
class UnknownMappingKeyError(MappingError):
...
class MappingValueError(MappingError):
...
class MappingReferenceError(MappingError):

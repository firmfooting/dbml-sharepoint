...
| Reception | n/a | Front-door sign-ins, the morning tidy-up |
| Every host | n/a | Their guests: induction, escort rules, sign-out |
| Wardens | n/a | Using *On site now* at the assembly point |
...
## Privacy and retention (visit rows are personal data)

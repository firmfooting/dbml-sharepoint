...
convention in `40-adopt/staff-guide.md` to match. Both formulas were run on
a live site on 2026-09-13, exactly as written here, and each filled its
column on a bare upload. The number

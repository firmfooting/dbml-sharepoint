...
leaves when they do. This register is CRM-shaped without CRM weight: any
team that manages external relationships, from partnerships and government
relations to media, suppliers and community groups, gets a shared view of
*who owns which relationship* and *when we last spoke*, on day one. It's
also the classic "we should have written that down" fix: the interaction
log turns handovers from an hour of oral history into a filter.
...
inventing people, because this register's privacy posture matters and the
seed is the first thing anyone sees.
...
rules are essential, not boilerplate).

...
# The site root, derived from the SiteUrl parameter rather than trusted as
# given, and the first binding of every query that consumes it. Emitted
# verbatim into both the per-list queries and the user-added-column audit, so
# there is one definition of what "the site" means across the whole pack.
#
